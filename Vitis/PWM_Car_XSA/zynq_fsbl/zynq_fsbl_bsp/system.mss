...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_IP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_IP_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_IP_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_IP_3
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = gpio_btns_sws
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.11
 PARAMETER HW_INSTANCE = gpio_leds_rgb
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = HC_SR04_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = HC_SR04_IP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = HC_SR04_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = HC_SR04_IP_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.11
 PARAMETER HW_INSTANCE = gpio_intr_mpu
END

...
HD_PWD='C:/DevWorks/Robot_Car_Pwm/Vivado/PWM_Car/PWM_Car.runs/design_1_SpeedSensor_IP_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SpeedSensor_IP_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SpeedSensor_IP_3_0.tcl

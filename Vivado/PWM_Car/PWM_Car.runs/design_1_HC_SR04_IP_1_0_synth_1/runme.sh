...
HD_PWD='C:/DevWorks/Robot_Car_PYNQ/Vivado/PWM_Car/PWM_Car.runs/design_1_HC_SR04_IP_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HC_SR04_IP_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HC_SR04_IP_1_0.tcl
